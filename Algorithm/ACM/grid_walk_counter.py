...
class gridWalkCounterTestCase(unittest.TestCase):
    def setUp(self):
        self.m,self.n=3,3

    def test_by_recursion(self):
        self.assertEqual(by_recursion(self.m,self.n),20)

    def test_by_factorial(self):
        self.assertEqual(by_factorial(self.m, self.n), 20)

    def test_by_daynamic_programming(self):
        self.assertEqual(by_daynamic_programming(self.m, self.n), 20)
