...
def preorder_label(T, p, d, path):            # path：递归签名的附加参数
  """Print labeled representation of subtree of T rooted at p at depth d.添加数字标题"""
...
def parenthesize(T, p):
  """Print parenthesized representation of subtree of T rooted at p.括号表示树结构
